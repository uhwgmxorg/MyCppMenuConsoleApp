...
void PrintMenu()
{
    ...
    ScreenOutput(X, Y + 5, "h Print compile hint");
...
void PrintCompileHint()
{
    ...
    ScreenOutput(30, 12, "press a key to continue", console_text_colors::red, console_bg_colors::white);
    _getch();
}
